...

{
  ...
  class Product{
    constructor(id, data){
      ...
      // console.logconsole.log('new Product:', thisProduct);
    }
    ...
    renderInMenu(){
      ...
      /* create elemrnt using utils.createElementFromHTML */
    ...
    initAccordion(){
      ...
      const productTitle = thisProduct.accordionTrigger;
    ...
    procesOrder(){
      ...
      // console.log('procesOrder:', thisProduct.params);
    }
  ...
  class CartProduct{
    ...
    remove(){
      ...
      console.log('Metoda Remove: ', thisCartProduct );
    }
